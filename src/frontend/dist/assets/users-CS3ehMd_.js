import { r as reactExports, j as jsxRuntimeExports, f as React, c as useInternetIdentity, k as useQueryClient } from "./index-C9bX-I14.js";
...
function useAuth() {
  ...
  const shortPrincipal = principalId ? `${principalId.slice(0, 5)}...${principalId.slice(-3)}` : null;
  return {
    login,
    logout,
    isAuthenticated,
